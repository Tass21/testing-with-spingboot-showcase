...
import com.tdksoft.testing.demo.customer.Customer;
import com.tdksoft.testing.demo.customer.CustomerRegistrationRequest;
...
class PaymentIntegrationTest {
    ...
    void itShouldCreatePaymentSuccessfully() throws Exception {
        ...
        String lastName = "watt";
        String email = "james.watt@tdksoft.com";
        String phoneNumber = "+4971520000";
        Integer age = 34;
        Customer customer = new Customer(customerId, firstName, lastName, email, age, phoneNumber);
